...
function Navbar() {
  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900 ">
      <div className="max-w-screen-xl flex flex-wrap flex-col md:flex-row md:items-center  items-start justify-between mx-0 lg:mx-0 xl:mx-28 md:mx sm:mx-0 p-2">
    ...
    <NavLink to="/" className="text-gray-700 hover:underline">HOME</NavLink>
    <span className="px-2"></span>
    <NavLink to="jobs" className="text-gray-700 hover:underline">REMOTE JOBS</NavLink>
    <span className="px-2"></span>
    <NavLink to="business" className="text-gray-700 hover:underline">BUSINESS OUTSOURCING
    </NavLink> <span className="px-2"></span>
          <NavLink to="learning" className="text-gray-700 hover:underline">E-LEARNING
          </NavLink><span className="px-2"></span>

      <NavLink to="about" className="text-gray-700 hover:underline">ABOUT US</NavLink><span className="px-2"></span>
  <NavLink to="admin" className="text-gray-700 hover:underline">ADMIN</NavLink><span className="px-8"></span>
        </div>
        <div className="flex flex-col sm:flex-col md:flex-row items-center md:order-2 space-x-0 md:space-x-0 rtl:space-x-reverse">
          <button
            type="button"
