...
function SocialMedia() {
  ...
  const SocialMediaCourses = courses.filter(
...
<div className='flex'>
      <h1 className="w-full h-28 text-gray-500 text-md flex items-center">
        You are here: Home / E-Learning / Social Media Marketing
      </h1>
...
<hr />
      ...
      <div className="flex flex-wrap gap-16   justify-center  mb-5">
        {SocialMediaCourses.length > 0 ? (
          SocialMediaCourses.map((item) => (
            <div
              key={item.id}
            ...
            <div>
          <p className="font-bold text-gray-600">No courses available yet in Social Media Marketing category.</p>
