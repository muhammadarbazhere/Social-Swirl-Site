...
function SocialMedia() {
    ...
    return (
        <div className="  font-[Chivo] bg-blue-100 py-10 px-10">
            <h1 className="text-3xl font-bold text-gray-800 text-center">Social Media Marketing Courses</h1>
            ...
            {frontEndCourses.length === 0 ? (
                <div className="flex justify-center h-full ">
                    <p className='text-lg text-center pt-12 text-gray-700 font-bold'>No social media marketing courses avalaible</p>
                </div>
            ) : (
