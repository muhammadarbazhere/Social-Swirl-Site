...
<div className='flex'>
      <h1 className="w-full h-28 text-gray-500 text-md flex items-center">
        You are here: Home / E-Learning / Graphic Designing
      </h1>
      ...
      <div className="flex flex-wrap gap-16   justify-center  mb-5">
        {graphicCourses.length > 0 ? (
          graphicCourses.map((item) => (
            ...
            <div>
          <p className="font-bold text-gray-600">No courses available yet in Graphic Designing category.</p>
